...
module.exports = router => {
    ...
    router.post('/registrasi', (req, res) => {
        ...
        if (!username || !firstname || !lastname || !email || !password || !username.trim() || !firstname.trim() || !lastname.trim()
            ...
            register.registerUser(username,lastname,firstname,email,password)
